# """Provide Color color constants and a colors dictionary with
...
class Color(object):
    def __init__(self, red, green, blue):
        ...
        self.green = green
        self.blue = blue
        self.cyan, self.magenta, self.yellow, self.key = rgb_to_cmyk(
...
def rgb_to_cmyk(r: int, g: int, b:int, cmyk_scale:int=100, rgb_scale:int=255) -> tuple:
    ...
    Args:
        ...
        g (int): Green
        b (int): Blue
        cmyk_scale (int, optional): CMYK scale. Defaults to 100.
        rgb_scale (int, optional): RGB scale. Defaults to 255.
...
def cmyk_to_rgb(c: int, m: int, y: int, k:int, cmyk_scale:int=100, rgb_scale:int=255) -> tuple:
    """
    Convert CMYK to RGB
